...
- Conta na Vercel
- Banco de dados PostgreSQL online (Supabase, Railway, Neon, etc.)
...
Ou conecte seu repositório GitHub diretamente na Vercel para deploy automático.

### Estrutura de URLs após Deploy
- **Página Principal:** `https://seu-projeto.vercel.app/`
- **Feed:** `https://seu-projeto.vercel.app/feed.html`
